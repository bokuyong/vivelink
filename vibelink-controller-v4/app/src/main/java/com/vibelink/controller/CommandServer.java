...
public class CommandServer {
    ...
    public interface CommandListener {
        ...
        void onVoiceCommand(String voiceText);
    }
    ...
    private void handleClient(Socket client) {
        try {
            ...
            // Parse JSON - supports both direct command and voice text
            String voiceText = extractJsonString(json, "voice_text");
            ...
            if (listener != null) {
                if (voiceText != null && !voiceText.isEmpty()) {
                    listener.onVoiceCommand(voiceText);
                } else if (recipient != null && amount > 0) {
                    listener.onTossCommand(recipient, amount);
                } else {
                    Log.w(TAG, "Invalid command - voice_text=" + voiceText +
